...
const Banner = () => {
  return (
    <section className="relative w-full min-h-150 lg:h-[80vh] flex items-center overflow-hidden bg-gray-50 rounded-2xl my-10">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-5%] w-100 h-100 rounded-full bg-[#5DF8D8]/10 blur-3xl" />
        <div className="absolute top-[20%] right-[-5%] w-75 h-75 rounded-full bg-[#3B7597]/10 blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-12 items-center z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#3B7597]/10 border border-[#3B7597]/20 text-[#3B7597] text-xs md:text-sm font-bold tracking-wide uppercase">
            <BiRocket className="text-lg" />
            Empowering Your Future
          </div>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-[#093C5D] leading-[1.1]">
            Upgrade Your <br />
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
            <Link href={"/courses"}>
              <Button
                size="lg"
                className="bg-[#3B7597] text-white font-bold h-14 px-10 rounded-2xl shadow-xl shadow-blue-200 w-full sm:w-auto"
              >
                Explore Courses
              </Button>
            </Link>
            <Button
              variant="light"
              size="lg"
              className="text-[#093C5D] font-bold h-14 px-8 rounded-2xl flex items-center gap-2 w-full sm:w-auto hover:bg-gray-100"
            >
          ...
          <div className="flex items-center gap-8 pt-4 border-t border-gray-200">
            <div>
              <p className="text-2xl font-bold text-[#093C5D]">12k+</p>
            ...
            <div>
              <p className="text-2xl font-bold text-[#093C5D]">150+</p>
              <p className="text-xs text-gray-400 font-semibold uppercase">
                Courses
              </p>
            </div>
            <div className="w-px h-8 bg-gray-200" />
            <div>
              <p className="text-2xl font-bold text-[#093C5D]">4.9/5</p>
              <p className="text-xs text-gray-400 font-semibold uppercase">
                Rating
              </p>
            </div>
        ...
        >
          <div className="relative z-10 w-[500px] h-[550px] mx-auto">
